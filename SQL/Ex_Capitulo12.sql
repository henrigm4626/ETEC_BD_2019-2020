...
/*Exercício 2*/
SELECT TOP 5 NumPed, DataPed FROM Pedidos ORDER BY Frete ASC

/*Exercício 3*/
SELECT Nome, Cargo FROM Clientes union SELECT Nome, Cargo FROM Funcionarios WHERE pais = 'Reino Unido'
...
/*Exercício 8*/
SELECT Nome, Cargo FROM Funcionarios UNION SELECT Contato, Cargo FROM Fornecedores WHERE pais = 'EUA'
